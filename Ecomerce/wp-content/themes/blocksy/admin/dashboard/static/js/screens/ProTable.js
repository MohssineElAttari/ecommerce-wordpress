	...
	return (
		<section className="ct-comparison-table">
			...
			<div className="ct-cta-container-small">
				<h2>{__('Blocksy Pro - 15% OFF!', 'blocksy')}</h2>
			...
			<div className="ct-cta-container">
				...
				<h2>Blocksy PRO - 15% OFF!</h2>

				<p>
					{__(
						`Hey friends, for a limited time you can get advantage of Blocksy Pro with a 15% discount on all our premium packages, hurry up this offer will end soon!`,
						'blocksy'
					)}
				</p>
				<a
